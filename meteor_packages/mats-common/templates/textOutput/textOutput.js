  ...
  elementHtml: function (element) {
    ...
    switch (plotType) {
      ...
      case matsTypes.PlotTypes.profile:
        if (isCTC) {
          ...
          line +=
            ...
            "</td>" +
            "<td>" +
            ("n" in element && element["n"] ? element["n"] : fillStr) +
            "</td>";
        }
        break;
      case matsTypes.PlotTypes.dieoff:
      ...
      case matsTypes.PlotTypes.reliability:
        line +=
          "<td>" +
          element[(labelKey += " probability bin")] +
          "</td>" +
          "<td>" +
          ...
          "</td>" +
          "<td>" +
          (element["oy"] !== undefined && element["oy"] !== null
            ? element["oy"]
            : fillStr) +
          "</td>" +
          "<td>" +
          (element["on"] !== undefined && element["on"] !== null
            ? element["on"]
            : fillStr) +
          "</td>";
        break;
      ...
      case matsTypes.PlotTypes.histogram:
        line +=
          "<td>" +
          element[(labelKey += " bin range")] +
          "</td>" +
          "<td>" +
          ("n" in element ? element["n"] : fillStr) +
          "</td>" +
          "<td>" +
    ...
    switch (Session.get("plotType")) {
      ...
      case matsTypes.PlotTypes.profile:
        line +=
          ...
          "</td>" +
          "<td>" +
          (stats["standard deviation"] !== undefined &&
          ...
          "</td>" +
          "<td>" +
          (stats["standard error"] !== undefined && stats["standard error"] !== null
            ? stats["standard error"].toPrecision(4)
            : "undefined"
          ).toString() +
          "</td>" +
          "<td>" +
          (stats["lag1"] !== undefined && stats["lag1"] !== null
            ? stats["lag1"].toPrecision(4)
            : "undefined"
          ).toString() +
          "</td>" +
          "<td>" +
          (stats["minimum"] !== undefined && stats["minimum"] !== null
            ? stats["minimum"].toPrecision(4)
            : "undefined"
          ).toString() +
          "</td>" +
          "<td>" +
          (stats["maximum"] !== undefined && stats["maximum"] !== null
      ...
      case matsTypes.PlotTypes.reliability:
        line +=
          ...
          "</td>" +
          "<td>" +
          (stats["sample climo"] !== undefined && stats["sample climo"] !== null
      ...
      case matsTypes.PlotTypes.roc:
        line +=
          ...
          "</td>" +
          "<td>" +
          (stats["auc"] !== undefined && stats["auc"] !== null
      ...
      case matsTypes.PlotTypes.map:
        line +=
          ...
          "</td>" +
          "<td>" +
          (stats["mean difference"] !== undefined && stats["mean difference"] !== null
          ...
          "</td>" +
          "<td>" +
          (stats["total number of obs"] !== undefined &&
          ...
          "</td>" +
          "<td>" +
          (stats["minimum time"] !== undefined && stats["minimum time"] !== null
            ? stats["minimum time"]
            : "undefined"
          ).toString() +
          "</td>" +
          "<td>" +
          (stats["maximum time"] !== undefined && stats["maximum time"] !== null
            ? stats["maximum time"]
            : "undefined"
          ).toString() +
          "</td>";
      ...
      case matsTypes.PlotTypes.contourDiff:
        line +=
          ...
          "</td>" +
          "<td>" +
          (stats["mean stat"] !== undefined && stats["mean stat"] !== null
            ? stats["mean stat"].toPrecision(4)
            : "undefined"
          ).toString() +
          "</td>" +
          "<td>" +
          (stats["total number of points"] !== undefined &&
