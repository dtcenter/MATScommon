...
Template.color.events({
    ...
    'change': function (event) {
        if (document.getElementById("controlButton-" + event.currentTarget.name + "-value") !== null) {
            ...
            document.querySelector('[name="' + event.currentTarget.name + "-icon" + '"]').style.color = event.currentTarget.value;
            document.querySelector('[name="' + event.currentTarget.name + "-icon" + '"]').value = event.currentTarget.value;
        }
    }
});