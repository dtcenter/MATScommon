...
const showSimpleScatterFace = function () {
  ...
  if (matsParamUtils.getParameterForName("x-threshold") !== undefined) {
    // we have an x-threshold and y-threshold for this app, so hide the single-threshold selector and show the x- and y-threshold selectors
    faceOptions.threshold = "none";
