...
class MatsMiddleValidTime {
  ...
  processStationQuery = (
    ...
    (async () => {
      ...
      console.log(`MatsMiddleValidTime.processStationQuery ERROR: ${err.message}`);
      rv = `MatsMiddleValidTime.processStationQuery ERROR: ${err.message}`;
      dFuture.return();
    });
    dFuture.wait();
    return rv;
  ...
  processStationQueryInt = async (
    ...
    try {
      ...
      console.log(`MatsMiddleValidTime.processStationQueryInt ERROR: ${err.message}`);
      throw new Error(
        `MatsMiddleValidTime.processStationQueryInt ERROR: ${err.message}`
      );
    }
  };
